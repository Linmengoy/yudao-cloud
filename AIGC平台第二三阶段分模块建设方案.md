...
```text
1. aigc-asset 增强：资产关系、资产版本、工作流资产关系
2. aigc-task 增强：主子任务、批量任务、工作流任务字段
3. aigc-gen 增强：图生图、图生视频、音频、文档、PPT、数字人入口
4. aigc-billing 增强：组合计费、差额释放、节点成本
5. aigc-workflow 新建：定义、节点、实例、执行器
6. aigc-template 新建：模板基础、参数 Schema、一键生成
7. aigc-safety 增强：模板审核、工作流审核、资产审核补偿
8. 管理端增强：工作流画布、模板管理、执行监控、成本报表
```
