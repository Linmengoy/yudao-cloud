CREATE TABLE `aigc_model_provider` (
  ...
  `proxy_id` bigint DEFAULT NULL COMMENT '代理 ID',
  `proxy_protocol` varchar(32) DEFAULT NULL COMMENT '代理协议',
  ...
  `proxy_password` varchar(1024) DEFAULT NULL COMMENT '代理密码',
