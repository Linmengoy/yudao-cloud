...
@Schema(description = "用户 APP - 通过邮箱重置密码 Request VO")
@Data
public class AppMemberUserResetPasswordByEmailReqVO {
    ...
    @Schema(description = "新密码", requiredMode = Schema.RequiredMode.REQUIRED, example = "abc123456")
