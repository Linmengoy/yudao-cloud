...
export interface UpdateUserPointReq {
  id: number | undefined
  point: number
  reason?: string
}
...
// 修改会员用户积分
export const updateUserPoint = async (data: UpdateUserPointReq) => {
  return await request.put({ url: `/member/user/update-point`, data })
}

// 修改会员用户状态
export const updateUserStatus = async (data: UpdateUserStatusReq) => {
