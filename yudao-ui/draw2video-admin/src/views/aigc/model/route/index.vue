<template>
  <ContentWrap>
    <el-form ref="queryFormRef" :model="queryParams" :inline="true" class="-mb-15px" label-width="68px">
      ...
      <el-form-item label="任务类型" prop="taskType"><el-input v-model="queryParams.taskType" class="!w-180px" clearable placeholder="请输入任务类型" @keyup.enter="handleQuery" /></el-form-item>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="任务类型" align="center" prop="taskType" min-width="110" />
      ...
      <el-table-column label="候选模型" align="center" prop="modelIds" min-width="160" />
...
import type { AigcModelRouteRespVO } from '@/api/aigc/model/types'
