      ...
      <el-col :span="20">
        <el-descriptions :column="2">
          ...
          <el-descriptions-item>
            ...
            {{ user.birthday ? formatDate(user.birthday as any) : '--' }}
          </el-descriptions-item>
          <el-descriptions-item>
            <template #label>
          ...
          <el-descriptions-item>
            ...
            {{ user.loginDate ? formatDate(user.loginDate as any) : '--' }}
          </el-descriptions-item>
          <el-descriptions-item>
            <template #label>
              <descriptions-item-label icon="ep:collection-tag" label="分组" />
            </template>
            {{ user.groupName || '--' }}
          </el-descriptions-item>
          <el-descriptions-item>
            <template #label>
              <descriptions-item-label icon="ep:discount" label="标签" />
            </template>
            <el-tag v-for="tagName in user.tagNames" :key="tagName" class="mr-5px">
              {{ tagName }}
            </el-tag>
            <span v-if="!user.tagNames?.length">--</span>
          </el-descriptions-item>
          <el-descriptions-item>
            <template #label>
              <descriptions-item-label icon="ep:memo" label="备注" />
            </template>
            {{ user.mark || '--' }}
          </el-descriptions-item>
        </el-descriptions>
